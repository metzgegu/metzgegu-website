...
<div class="flex lg:flex-row flex-col">
	<menu class="w-56 flex-col no-print dot-background hidden lg:flex">
		...
		<li class="border-b-2 border-t-2 border-r-2 p-1 border-black {$page.url.pathname === '/' ? 'border-r-white bg-white' : ''} border-transition">
			<a class="text-center w-56 block text-xl cursor-pointer" href="/">About me</a>
		</li>
		<li class="border-b-2 border-black border-r-2 p-1 {$page.url.pathname === '/projects' ? 'border-r-white bg-white' : ''} border-transition">
			<a class="text-center w-56 block text-xl cursor-pointer" href="/projects">Projects</a>
		</li>
		<li class="border-b-2 border-black border-r-2 p-1 {$page.url.pathname === '/cv' ? 'border-r-white bg-white' : ''} border-transition">
			<a class="text-center w-56 block text-xl cursor-pointer" href="/cv">CV</a>
		</li>
		<div class="flex flex-col flex-1 border-r-2 border-black justify-end pb-4">
			<SocialLinks
